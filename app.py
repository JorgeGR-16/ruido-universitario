...
#_________________________________________________________Resultados________________________________________________________________#
    ...
    with st.sidebar:
        ...
        uploaded_file = "40nodos.csv"  # Ruta fija al archivo subido
    ...
    if not df_filtrado.empty:
        ...
        with tab1:
            st.markdown("### 🔊 Mapa de niveles de sonido con alertas")
            ...
            ax.set_title("💥 Mapa de niveles de sonido con alertas visuales", fontsize=14)
