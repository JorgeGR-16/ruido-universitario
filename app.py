...
if seccion_activa == "Introducción":
    ...
    @st.cache_data
    def load_data():
        sheet_url = "https://docs.google.com/spreadsheets/d/1YgTum-zyxJ77Y1yOzA5xM33exNOTIY8RnNHYuvMnX58/edit?usp=sharing"
    ...
    if columna_nodo in df.columns:
        ...
        st.subheader("🔹 Nodos disponibles en el archivo")
        st.write(f"Se encontraron **{len(nodos_unicos)}** nodos:")
